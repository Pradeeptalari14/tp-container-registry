# 🏷️ Container Registry Studio
> Generate Cosign image signing scripts, Harbor tag retention rules, and registry configurations.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/container-registry/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/container-registry/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-container-registry.git
cd tp-container-registry
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/container-registry/) |
